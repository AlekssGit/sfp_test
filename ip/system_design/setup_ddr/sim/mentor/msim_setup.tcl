...
# ----------------------------------------
# If setup_ddr is one of several IP cores in your
...
=======
# ACDS 21.3 170 win32 2023.05.07.10:38:47
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "setup_ddr.setup_ddr"
}
...
append ELAB_OPTIONS [subst [setup_ddr::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [setup_ddr::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [setup_ddr::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [setup_ddr::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [setup_ddr::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [setup_ddr::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
