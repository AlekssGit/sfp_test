...
# ----------------------------------------
# If init_mac is one of several IP cores in your
...
# ----------------------------------------
<<<<<<< HEAD
# ACDS 21.4 67 win32 2023.05.08.12:05:42
=======
# ACDS 21.3 170 win32 2023.05.07.10:37:40
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "init_mac.init_mac"
}
...
append ELAB_OPTIONS [subst [init_mac::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [init_mac::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [init_mac::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [init_mac::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [init_mac::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [init_mac::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
