...
# ----------------------------------------
# If mem_0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.3 170 win32 2022.09.20.18:10:39
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mem_0.mem_0"
}
...
append ELAB_OPTIONS [subst [mem_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [mem_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [mem_0::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [mem_0::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [mem_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [mem_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
