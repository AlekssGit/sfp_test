	mem_4 u0 (
		...
		.address     (_connected_to_address_),     //   input,  width = 10,     s1.address
		...
		.address2    (_connected_to_address2_),    //   input,  width = 10,     s2.address
		...
		.readdata2   (_connected_to_readdata2_),   //  output,  width = 32,       .readdata
		.writedata2  (_connected_to_writedata2_),  //   input,  width = 32,       .writedata
		.byteenable2 (_connected_to_byteenable2_), //   input,   width = 4,       .byteenable
