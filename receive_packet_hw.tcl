...
# Wed Sep 21 14:36:16 MSK 2022
# DO NOT MODIFY


# 
# receive_packet "receive_packet" v1.0
#  2022.09.21.14:36:16
# 
# 
...
set_module_property NAME receive_packet
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME receive_packet
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL receive_packet_256
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file receive_packet.sv SYSTEM_VERILOG PATH modules/receive_packet.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL receive_packet_256
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file receive_packet.sv SYSTEM_VERILOG PATH modules/receive_packet.sv
...
add_interface_port avalon_master ram_addr address Output 10
add_interface_port avalon_master ram_chipselect chipselect Output 1
add_interface_port avalon_master ram_write write Output 1
add_interface_port avalon_master ram_readdata readdata Input 32
add_interface_port avalon_master ram_writedata writedata Output 32
add_interface_port avalon_master ram_byteenable byteenable Output 4
add_interface_port avalon_master ram_waitrequest waitrequest Input 1
...
add_interface_port clock clk_original clk Input 1
...
add_interface_port fifo_status rx_afull_channel channel Output 2
...
# 
# connection point data_saved
# 
add_interface data_saved conduit end
set_interface_property data_saved associatedClock clock
set_interface_property data_saved associatedReset reset
set_interface_property data_saved ENABLED true
set_interface_property data_saved EXPORT_OF ""
set_interface_property data_saved PORT_NAME_MAP ""
set_interface_property data_saved CMSIS_SVD_VARIABLES ""
set_interface_property data_saved SVD_ADDRESS_GROUP ""
set_interface_property data_saved IPXACT_REGISTER_MAP_VARIABLES ""

add_interface_port data_saved data_saved data_saved Output 1
