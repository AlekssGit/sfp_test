// system_design_altera_mm_interconnect_1920_cessh5i.v
...
`timescale 1 ps / 1 ps
module system_design_altera_mm_interconnect_1920_cessh5i (
	...
	wire  [403:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> setup_ddr_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                          // setup_ddr_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> setup_ddr_avalon_master_agent:rp_channel
	...
	wire  [403:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> ddr3_ctrl_amm_0_agent:cp_data
	wire          cmd_mux_src_ready;                                                          // ddr3_ctrl_amm_0_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> ddr3_ctrl_amm_0_agent:cp_channel
	...
	wire  [403:0] setup_ddr_avalon_master_agent_cp_data;                                      // setup_ddr_avalon_master_agent:cp_data -> router:sink_data
	...
	wire          pcie_rxm_bar2_agent_cp_valid;                                               // pcie_rxm_bar2_agent:cp_valid -> router_001:sink_valid
	wire  [259:0] pcie_rxm_bar2_agent_cp_data;                                                // pcie_rxm_bar2_agent:cp_data -> router_001:sink_data
	wire          pcie_rxm_bar2_agent_cp_ready;                                               // router_001:sink_ready -> pcie_rxm_bar2_agent:cp_ready
	wire          pcie_rxm_bar2_agent_cp_startofpacket;                                       // pcie_rxm_bar2_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          pcie_rxm_bar2_agent_cp_endofpacket;                                         // pcie_rxm_bar2_agent:cp_endofpacket -> router_001:sink_endofpacket
	wire          ddr3_ctrl_amm_0_agent_rp_valid;                                             // ddr3_ctrl_amm_0_agent:rp_valid -> router_002:sink_valid
	wire  [403:0] ddr3_ctrl_amm_0_agent_rp_data;                                              // ddr3_ctrl_amm_0_agent:rp_data -> router_002:sink_data
	wire          ddr3_ctrl_amm_0_agent_rp_ready;                                             // router_002:sink_ready -> ddr3_ctrl_amm_0_agent:rp_ready
	wire          ddr3_ctrl_amm_0_agent_rp_startofpacket;                                     // ddr3_ctrl_amm_0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          ddr3_ctrl_amm_0_agent_rp_endofpacket;                                       // ddr3_ctrl_amm_0_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          rsp_mux_001_src_valid;                                                      // rsp_mux_001:src_valid -> pcie_rxm_bar2_rsp_width_adapter:in_valid
	wire  [403:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> pcie_rxm_bar2_rsp_width_adapter:in_data
	wire          rsp_mux_001_src_ready;                                                      // pcie_rxm_bar2_rsp_width_adapter:in_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> pcie_rxm_bar2_rsp_width_adapter:in_channel
	wire          rsp_mux_001_src_startofpacket;                                              // rsp_mux_001:src_startofpacket -> pcie_rxm_bar2_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                // rsp_mux_001:src_endofpacket -> pcie_rxm_bar2_rsp_width_adapter:in_endofpacket
	wire          pcie_rxm_bar2_rsp_width_adapter_src_valid;                                  // pcie_rxm_bar2_rsp_width_adapter:out_valid -> pcie_rxm_bar2_agent:rp_valid
	wire  [259:0] pcie_rxm_bar2_rsp_width_adapter_src_data;                                   // pcie_rxm_bar2_rsp_width_adapter:out_data -> pcie_rxm_bar2_agent:rp_data
	wire          pcie_rxm_bar2_rsp_width_adapter_src_ready;                                  // pcie_rxm_bar2_agent:rp_ready -> pcie_rxm_bar2_rsp_width_adapter:out_ready
	wire    [1:0] pcie_rxm_bar2_rsp_width_adapter_src_channel;                                // pcie_rxm_bar2_rsp_width_adapter:out_channel -> pcie_rxm_bar2_agent:rp_channel
	...
	wire          router_001_src_valid;                                                       // router_001:src_valid -> pcie_rxm_bar2_cmd_width_adapter:in_valid
	wire  [259:0] router_001_src_data;                                                        // router_001:src_data -> pcie_rxm_bar2_cmd_width_adapter:in_data
	wire          router_001_src_ready;                                                       // pcie_rxm_bar2_cmd_width_adapter:in_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                                     // router_001:src_channel -> pcie_rxm_bar2_cmd_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                               // router_001:src_startofpacket -> pcie_rxm_bar2_cmd_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                 // router_001:src_endofpacket -> pcie_rxm_bar2_cmd_width_adapter:in_endofpacket
	wire          pcie_rxm_bar2_cmd_width_adapter_src_valid;                                  // pcie_rxm_bar2_cmd_width_adapter:out_valid -> cmd_demux_001:sink_valid
	wire  [403:0] pcie_rxm_bar2_cmd_width_adapter_src_data;                                   // pcie_rxm_bar2_cmd_width_adapter:out_data -> cmd_demux_001:sink_data
	wire          pcie_rxm_bar2_cmd_width_adapter_src_ready;                                  // cmd_demux_001:sink_ready -> pcie_rxm_bar2_cmd_width_adapter:out_ready
	wire    [1:0] pcie_rxm_bar2_cmd_width_adapter_src_channel;                                // pcie_rxm_bar2_cmd_width_adapter:out_channel -> cmd_demux_001:sink_channel
	wire          pcie_rxm_bar2_cmd_width_adapter_src_startofpacket;                          // pcie_rxm_bar2_cmd_width_adapter:out_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          pcie_rxm_bar2_cmd_width_adapter_src_endofpacket;                            // pcie_rxm_bar2_cmd_width_adapter:out_endofpacket -> cmd_demux_001:sink_endofpacket
	wire          cmd_demux_001_src0_valid;                                                   // cmd_demux_001:src0_valid -> crosser:in_valid
	wire  [403:0] cmd_demux_001_src0_data;                                                    // cmd_demux_001:src0_data -> crosser:in_data
	...
	wire  [403:0] crosser_out_data;                                                           // crosser:out_data -> cmd_mux:sink1_data
	...
	wire  [403:0] rsp_demux_src1_data;                                                        // rsp_demux:src1_data -> crosser_001:in_data
	...
	wire  [403:0] crosser_001_out_data;                                                       // crosser_001:out_data -> rsp_mux_001:sink0_data
	...
	system_design_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (setup_ddr_avalon_master_agent_cp_data),                                      //  output,  width = 404,          .data
	...
	system_design_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.rp_data               (pcie_rxm_bar2_rsp_width_adapter_src_data),                         //   input,  width = 260,          .data
		.rp_channel            (pcie_rxm_bar2_rsp_width_adapter_src_channel),                      //   input,    width = 2,          .channel
	...
	system_design_altera_merlin_router_1920_h3ufi5i router (
		...
		.sink_data          (setup_ddr_avalon_master_agent_cp_data),                                //   input,  width = 404,          .data
	...
	system_design_altera_merlin_router_1920_engkfgq router_001 (
		...
		.src_data           (router_001_src_data),                                        //  output,  width = 260,          .data
		.src_channel        (router_001_src_channel),                                     //  output,    width = 2,          .channel
		.src_startofpacket  (router_001_src_startofpacket),                               //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                                  //  output,    width = 1,          .endofpacket
	);

	system_design_altera_merlin_router_1920_hvfjwaq router_002 (
	...
	system_design_altera_merlin_demultiplexer_1921_g5kdmwq cmd_demux (
		.clk                (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset              (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_demultiplexer_1921_g5kdmwq cmd_demux_001 (
		.clk                (pcie_coreclkout_hip_clk),                                    //   input,    width = 1,       clk.clk
		.reset              (pcie_rxm_bar2_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (pcie_rxm_bar2_cmd_width_adapter_src_ready),                  //  output,    width = 1,      sink.ready
		.sink_channel       (pcie_rxm_bar2_cmd_width_adapter_src_channel),                //   input,    width = 2,          .channel
		.sink_data          (pcie_rxm_bar2_cmd_width_adapter_src_data),                   //   input,  width = 404,          .data
	...
	system_design_altera_merlin_multiplexer_1921_e3xy3ha cmd_mux (
		.clk                 (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset               (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (crosser_out_data),                                                     //   input,  width = 404,          .data
	...
	system_design_altera_merlin_demultiplexer_1921_ch7epuq rsp_demux (
		.clk                (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset              (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_multiplexer_1921_pf5e3wa rsp_mux (
		.clk                 (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset               (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_multiplexer_1921_pf5e3wa rsp_mux_001 (
		.clk                 (pcie_coreclkout_hip_clk),                                    //   input,    width = 1,       clk.clk
		.reset               (pcie_rxm_bar2_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (crosser_001_out_data),                                       //   input,  width = 404,          .data
	...
	system_design_altera_merlin_width_adapter_1920_tvac3wq #(
		...
		.in_data              (rsp_mux_001_src_data),                                       //   input,  width = 404,          .data
		.out_endofpacket      (pcie_rxm_bar2_rsp_width_adapter_src_endofpacket),            //  output,    width = 1,       src.endofpacket
		.out_data             (pcie_rxm_bar2_rsp_width_adapter_src_data),                   //  output,  width = 260,          .data
		.out_channel          (pcie_rxm_bar2_rsp_width_adapter_src_channel),                //  output,    width = 2,          .channel
	...
	system_design_altera_merlin_width_adapter_1920_cgbsazy #(
		...
		.in_data              (router_001_src_data),                                        //   input,  width = 260,          .data
		.out_endofpacket      (pcie_rxm_bar2_cmd_width_adapter_src_endofpacket),            //  output,    width = 1,       src.endofpacket
		.out_data             (pcie_rxm_bar2_cmd_width_adapter_src_data),                   //  output,  width = 404,          .data
		.out_channel          (pcie_rxm_bar2_cmd_width_adapter_src_channel),                //  output,    width = 2,          .channel
	...
	system_design_hs_clk_xer_1931_qzbstyq #(
		.DATA_WIDTH          (404),
		.BITS_PER_SYMBOL     (404),
		.USE_PACKETS         (1),
		.USE_CHANNEL         (1),
		...
		.in_data           (cmd_demux_001_src0_data),                                              //   input,  width = 404,              .data
		...
		.out_data          (crosser_out_data),                                                     //  output,  width = 404,              .data
		.in_empty          (1'b0),                                                                 // (terminated),                             
		.in_error          (1'b0),                                                                 // (terminated),                             
		.out_empty         (),                                                                     // (terminated),                             
		.out_error         ()                                                                      // (terminated),                             
	...
	system_design_hs_clk_xer_1931_qzbstyq #(
		...
		.in_data           (rsp_demux_src1_data),                                                  //   input,  width = 404,              .data
		...
		.out_data          (crosser_001_out_data),                                                 //  output,  width = 404,              .data
		.in_empty          (1'b0),                                                                 // (terminated),                             
		.in_error          (1'b0),                                                                 // (terminated),                             
		.out_empty         (),                                                                     // (terminated),                             
		.out_error         ()                                                                      // (terminated),                             
