// system_design_altera_mm_interconnect_1920_ta44f2y.v
...
`timescale 1 ps / 1 ps
module system_design_altera_mm_interconnect_1920_ta44f2y (
	...
	wire         send_packet_2_avalon_master_translator_avalon_universal_master_0_waitrequest;   // mem_2_s1_translator:uav_waitrequest -> send_packet_2_avalon_master_translator:uav_waitrequest
	wire  [31:0] send_packet_2_avalon_master_translator_avalon_universal_master_0_readdata;      // mem_2_s1_translator:uav_readdata -> send_packet_2_avalon_master_translator:uav_readdata
	wire         send_packet_2_avalon_master_translator_avalon_universal_master_0_debugaccess;   // send_packet_2_avalon_master_translator:uav_debugaccess -> mem_2_s1_translator:uav_debugaccess
	wire  [11:0] send_packet_2_avalon_master_translator_avalon_universal_master_0_address;       // send_packet_2_avalon_master_translator:uav_address -> mem_2_s1_translator:uav_address
	wire         send_packet_2_avalon_master_translator_avalon_universal_master_0_read;          // send_packet_2_avalon_master_translator:uav_read -> mem_2_s1_translator:uav_read
	wire   [3:0] send_packet_2_avalon_master_translator_avalon_universal_master_0_byteenable;    // send_packet_2_avalon_master_translator:uav_byteenable -> mem_2_s1_translator:uav_byteenable
	wire         send_packet_2_avalon_master_translator_avalon_universal_master_0_readdatavalid; // mem_2_s1_translator:uav_readdatavalid -> send_packet_2_avalon_master_translator:uav_readdatavalid
	wire         send_packet_2_avalon_master_translator_avalon_universal_master_0_lock;          // send_packet_2_avalon_master_translator:uav_lock -> mem_2_s1_translator:uav_lock
	wire         send_packet_2_avalon_master_translator_avalon_universal_master_0_write;         // send_packet_2_avalon_master_translator:uav_write -> mem_2_s1_translator:uav_write
	wire  [31:0] send_packet_2_avalon_master_translator_avalon_universal_master_0_writedata;     // send_packet_2_avalon_master_translator:uav_writedata -> mem_2_s1_translator:uav_writedata
	wire   [2:0] send_packet_2_avalon_master_translator_avalon_universal_master_0_burstcount;    // send_packet_2_avalon_master_translator:uav_burstcount -> mem_2_s1_translator:uav_burstcount
