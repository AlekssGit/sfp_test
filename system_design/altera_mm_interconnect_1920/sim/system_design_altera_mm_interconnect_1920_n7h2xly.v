// system_design_altera_mm_interconnect_1920_n7h2xly.v
...
`timescale 1 ps / 1 ps
module system_design_altera_mm_interconnect_1920_n7h2xly (
		...
		input  wire         setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset, // setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset.reset
	...
	wire    [2:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> setup_ddr_avalon_master_agent:rp_channel
	...
	wire    [2:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> tx_2_avalon_master_agent:rp_channel
	...
	wire    [2:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> ddr3_ctrl_amm_0_agent:cp_channel
	...
	wire          pcie_rxm_bar2_agent_cp_valid;                                               // pcie_rxm_bar2_agent:cp_valid -> router_002:sink_valid
	wire  [261:0] pcie_rxm_bar2_agent_cp_data;                                                // pcie_rxm_bar2_agent:cp_data -> router_002:sink_data
	wire          pcie_rxm_bar2_agent_cp_ready;                                               // router_002:sink_ready -> pcie_rxm_bar2_agent:cp_ready
	wire          pcie_rxm_bar2_agent_cp_startofpacket;                                       // pcie_rxm_bar2_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          pcie_rxm_bar2_agent_cp_endofpacket;                                         // pcie_rxm_bar2_agent:cp_endofpacket -> router_002:sink_endofpacket
	wire          ddr3_ctrl_amm_0_agent_rp_valid;                                             // ddr3_ctrl_amm_0_agent:rp_valid -> router_003:sink_valid
	wire  [405:0] ddr3_ctrl_amm_0_agent_rp_data;                                              // ddr3_ctrl_amm_0_agent:rp_data -> router_003:sink_data
	wire          ddr3_ctrl_amm_0_agent_rp_ready;                                             // router_003:sink_ready -> ddr3_ctrl_amm_0_agent:rp_ready
	wire          ddr3_ctrl_amm_0_agent_rp_startofpacket;                                     // ddr3_ctrl_amm_0_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          ddr3_ctrl_amm_0_agent_rp_endofpacket;                                       // ddr3_ctrl_amm_0_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          rsp_mux_002_src_valid;                                                      // rsp_mux_002:src_valid -> pcie_rxm_bar2_rsp_width_adapter:in_valid
	wire  [405:0] rsp_mux_002_src_data;                                                       // rsp_mux_002:src_data -> pcie_rxm_bar2_rsp_width_adapter:in_data
	wire          rsp_mux_002_src_ready;                                                      // pcie_rxm_bar2_rsp_width_adapter:in_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                                    // rsp_mux_002:src_channel -> pcie_rxm_bar2_rsp_width_adapter:in_channel
	wire          rsp_mux_002_src_startofpacket;                                              // rsp_mux_002:src_startofpacket -> pcie_rxm_bar2_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                // rsp_mux_002:src_endofpacket -> pcie_rxm_bar2_rsp_width_adapter:in_endofpacket
	...
	wire    [2:0] pcie_rxm_bar2_rsp_width_adapter_src_channel;                                // pcie_rxm_bar2_rsp_width_adapter:out_channel -> pcie_rxm_bar2_agent:rp_channel
	...
	wire          router_002_src_valid;                                                       // router_002:src_valid -> pcie_rxm_bar2_cmd_width_adapter:in_valid
	wire  [261:0] router_002_src_data;                                                        // router_002:src_data -> pcie_rxm_bar2_cmd_width_adapter:in_data
	wire          router_002_src_ready;                                                       // pcie_rxm_bar2_cmd_width_adapter:in_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                                     // router_002:src_channel -> pcie_rxm_bar2_cmd_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                               // router_002:src_startofpacket -> pcie_rxm_bar2_cmd_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                 // router_002:src_endofpacket -> pcie_rxm_bar2_cmd_width_adapter:in_endofpacket
	wire          pcie_rxm_bar2_cmd_width_adapter_src_valid;                                  // pcie_rxm_bar2_cmd_width_adapter:out_valid -> cmd_demux_002:sink_valid
	wire  [405:0] pcie_rxm_bar2_cmd_width_adapter_src_data;                                   // pcie_rxm_bar2_cmd_width_adapter:out_data -> cmd_demux_002:sink_data
	wire          pcie_rxm_bar2_cmd_width_adapter_src_ready;                                  // cmd_demux_002:sink_ready -> pcie_rxm_bar2_cmd_width_adapter:out_ready
	wire    [2:0] pcie_rxm_bar2_cmd_width_adapter_src_channel;                                // pcie_rxm_bar2_cmd_width_adapter:out_channel -> cmd_demux_002:sink_channel
	wire          pcie_rxm_bar2_cmd_width_adapter_src_startofpacket;                          // pcie_rxm_bar2_cmd_width_adapter:out_startofpacket -> cmd_demux_002:sink_startofpacket
	wire          pcie_rxm_bar2_cmd_width_adapter_src_endofpacket;                            // pcie_rxm_bar2_cmd_width_adapter:out_endofpacket -> cmd_demux_002:sink_endofpacket
	wire          cmd_demux_002_src0_valid;                                                   // cmd_demux_002:src0_valid -> crosser:in_valid
	wire  [405:0] cmd_demux_002_src0_data;                                                    // cmd_demux_002:src0_data -> crosser:in_data
	wire          cmd_demux_002_src0_ready;                                                   // crosser:in_ready -> cmd_demux_002:src0_ready
	wire    [2:0] cmd_demux_002_src0_channel;                                                 // cmd_demux_002:src0_channel -> crosser:in_channel
	...
	wire  [405:0] crosser_out_data;                                                           // crosser:out_data -> cmd_mux:sink2_data
	wire          crosser_out_ready;                                                          // cmd_mux:sink2_ready -> crosser:out_ready
	wire    [2:0] crosser_out_channel;                                                        // crosser:out_channel -> cmd_mux:sink2_channel
	...
	wire  [405:0] rsp_demux_src2_data;                                                        // rsp_demux:src2_data -> crosser_001:in_data
	wire          rsp_demux_src2_ready;                                                       // crosser_001:in_ready -> rsp_demux:src2_ready
	wire    [2:0] rsp_demux_src2_channel;                                                     // rsp_demux:src2_channel -> crosser_001:in_channel
	...
	wire  [405:0] crosser_001_out_data;                                                       // crosser_001:out_data -> rsp_mux_002:sink0_data
	wire          crosser_001_out_ready;                                                      // rsp_mux_002:sink0_ready -> crosser_001:out_ready
	wire    [2:0] crosser_001_out_channel;                                                    // crosser_001:out_channel -> rsp_mux_002:sink0_channel
	...
	system_design_altera_merlin_master_translator_191_g7h47bq #(
		...
		.reset                  (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset),       //   input,    width = 1,                     reset.reset
	...
	system_design_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.clk                   (ddr3_emif_usr_clk_clk),                                                      //   input,    width = 1,       clk.clk
		.reset                 (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.rp_channel            (rsp_mux_001_src_channel),                                               //   input,    width = 3,          .channel
	...
	system_design_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.rp_channel            (pcie_rxm_bar2_rsp_width_adapter_src_channel),                      //   input,    width = 3,          .channel
	...
	system_design_altera_merlin_router_1920_6c6s3mi router (
	...
	system_design_altera_merlin_router_1920_6c6s3mi router_001 (
	...
	system_design_altera_merlin_router_1920_y76mhuq router_002 (
	...
	system_design_altera_merlin_router_1920_5nqso4i router_003 (
	...
	system_design_altera_merlin_demultiplexer_1921_3fhf7iy cmd_demux (
		.clk                (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset              (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_demultiplexer_1921_3fhf7iy cmd_demux_001 (
		.clk                (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset              (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_demultiplexer_1921_3fhf7iy cmd_demux_002 (
		.clk                (pcie_coreclkout_hip_clk),                                    //   input,    width = 1,       clk.clk
		.reset              (pcie_rxm_bar2_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (pcie_rxm_bar2_cmd_width_adapter_src_ready),                  //  output,    width = 1,      sink.ready
		.sink_channel       (pcie_rxm_bar2_cmd_width_adapter_src_channel),                //   input,    width = 3,          .channel
	...
	system_design_altera_merlin_multiplexer_1921_rx6perq cmd_mux (
		.clk                 (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset               (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_ready         (crosser_out_ready),                                                    //  output,    width = 1,     sink2.ready
		.sink2_valid         (crosser_out_valid),                                                    //   input,    width = 1,          .valid
		.sink2_channel       (crosser_out_channel),                                                  //   input,    width = 3,          .channel
		.sink2_data          (crosser_out_data),                                                     //   input,  width = 406,          .data
		.sink2_startofpacket (crosser_out_startofpacket),                                            //   input,    width = 1,          .startofpacket
		.sink2_endofpacket   (crosser_out_endofpacket)                                               //   input,    width = 1,          .endofpacket
	);

	system_design_altera_merlin_demultiplexer_1921_eufou7q rsp_demux (
		.clk                (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset              (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_multiplexer_1921_gnu7tby rsp_mux (
		.clk                 (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset               (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_multiplexer_1921_gnu7tby rsp_mux_001 (
		.clk                 (ddr3_emif_usr_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset               (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_multiplexer_1921_gnu7tby rsp_mux_002 (
		.clk                 (pcie_coreclkout_hip_clk),                                    //   input,    width = 1,       clk.clk
		.reset               (pcie_rxm_bar2_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_design_altera_merlin_width_adapter_1920_2mmyxna #(
		...
		.in_data              (rsp_mux_002_src_data),                                       //   input,  width = 406,          .data
		...
		.out_channel          (pcie_rxm_bar2_rsp_width_adapter_src_channel),                //  output,    width = 3,          .channel
	...
	system_design_altera_merlin_width_adapter_1920_6dmdx7y #(
		...
		.in_data              (router_002_src_data),                                        //   input,  width = 262,          .data
		...
		.out_channel          (pcie_rxm_bar2_cmd_width_adapter_src_channel),                //  output,    width = 3,          .channel
	...
	system_design_hs_clk_xer_1931_isngpdi #(
		.DATA_WIDTH          (406),
		.BITS_PER_SYMBOL     (406),
		.USE_PACKETS         (1),
		.USE_CHANNEL         (1),
		...
		.out_reset         (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, out_clk_reset.reset
		...
		.in_data           (cmd_demux_002_src0_data),                                              //   input,  width = 406,              .data
	...
	system_design_hs_clk_xer_1931_isngpdi #(
		...
		.in_reset          (setup_ddr_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  in_clk_reset.reset
		...
		.in_data           (rsp_demux_src2_data),                                                  //   input,  width = 406,              .data
