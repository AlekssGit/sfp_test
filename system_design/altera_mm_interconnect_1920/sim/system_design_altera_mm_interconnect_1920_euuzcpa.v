// system_design_altera_mm_interconnect_1920_euuzcpa.v
...
`timescale 1 ps / 1 ps
module system_design_altera_mm_interconnect_1920_euuzcpa (
		...
		output wire [9:0]  mem_rcv_2_s1_address,                               //                                 mem_rcv_2_s1.address
		output wire        mem_rcv_2_s1_write,                                 //                                             .write
		input  wire [31:0] mem_rcv_2_s1_readdata,                              //                                             .readdata
		output wire [31:0] mem_rcv_2_s1_writedata,                             //                                             .writedata
		output wire [3:0]  mem_rcv_2_s1_byteenable,                            //                                             .byteenable
		output wire        mem_rcv_2_s1_chipselect,                            //                                             .chipselect
		output wire        mem_rcv_2_s1_clken,                                 //                                             .clken
	...
	wire         receive_packet_2_avalon_master_translator_avalon_universal_master_0_waitrequest;   // mem_rcv_2_s1_translator:uav_waitrequest -> receive_packet_2_avalon_master_translator:uav_waitrequest
	wire  [31:0] receive_packet_2_avalon_master_translator_avalon_universal_master_0_readdata;      // mem_rcv_2_s1_translator:uav_readdata -> receive_packet_2_avalon_master_translator:uav_readdata
	wire         receive_packet_2_avalon_master_translator_avalon_universal_master_0_debugaccess;   // receive_packet_2_avalon_master_translator:uav_debugaccess -> mem_rcv_2_s1_translator:uav_debugaccess
	wire  [11:0] receive_packet_2_avalon_master_translator_avalon_universal_master_0_address;       // receive_packet_2_avalon_master_translator:uav_address -> mem_rcv_2_s1_translator:uav_address
	wire         receive_packet_2_avalon_master_translator_avalon_universal_master_0_read;          // receive_packet_2_avalon_master_translator:uav_read -> mem_rcv_2_s1_translator:uav_read
	wire   [3:0] receive_packet_2_avalon_master_translator_avalon_universal_master_0_byteenable;    // receive_packet_2_avalon_master_translator:uav_byteenable -> mem_rcv_2_s1_translator:uav_byteenable
	wire         receive_packet_2_avalon_master_translator_avalon_universal_master_0_readdatavalid; // mem_rcv_2_s1_translator:uav_readdatavalid -> receive_packet_2_avalon_master_translator:uav_readdatavalid
	wire         receive_packet_2_avalon_master_translator_avalon_universal_master_0_lock;          // receive_packet_2_avalon_master_translator:uav_lock -> mem_rcv_2_s1_translator:uav_lock
	wire         receive_packet_2_avalon_master_translator_avalon_universal_master_0_write;         // receive_packet_2_avalon_master_translator:uav_write -> mem_rcv_2_s1_translator:uav_write
	wire  [31:0] receive_packet_2_avalon_master_translator_avalon_universal_master_0_writedata;     // receive_packet_2_avalon_master_translator:uav_writedata -> mem_rcv_2_s1_translator:uav_writedata
	wire   [2:0] receive_packet_2_avalon_master_translator_avalon_universal_master_0_burstcount;    // receive_packet_2_avalon_master_translator:uav_burstcount -> mem_rcv_2_s1_translator:uav_burstcount
	...
	system_design_altera_merlin_slave_translator_191_x56fcki #(
		...
		.av_address             (mem_rcv_2_s1_address),                                                              //  output,  width = 10,      avalon_anti_slave_0.address
		.av_write               (mem_rcv_2_s1_write),                                                                //  output,   width = 1,                         .write
		.av_readdata            (mem_rcv_2_s1_readdata),                                                             //   input,  width = 32,                         .readdata
		.av_writedata           (mem_rcv_2_s1_writedata),                                                            //  output,  width = 32,                         .writedata
		.av_byteenable          (mem_rcv_2_s1_byteenable),                                                           //  output,   width = 4,                         .byteenable
		.av_chipselect          (mem_rcv_2_s1_chipselect),                                                           //  output,   width = 1,                         .chipselect
		.av_clken               (mem_rcv_2_s1_clken),                                                                //  output,   width = 1,                         .clken
		.av_read                (),                                                                                  // (terminated),                                       
