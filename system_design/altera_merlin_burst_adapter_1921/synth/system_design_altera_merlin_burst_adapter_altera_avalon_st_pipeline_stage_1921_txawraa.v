// system_design_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1921_txawraa.v

// Generated using ACDS version 21.4 67

`timescale 1 ps / 1 ps
module system_design_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1921_txawraa #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 150,
	...
	system_design_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 150,          .data
		...
		.out_data          (out_data),          //  output,  width = 150,          .data
