...
source [file join [file dirname [info script]] ./../../../ip/system_design/mem_1/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/system_design/mem_0/sim/common/modelsim_files.tcl]
...
namespace eval system_design {
  proc get_design_libraries {} {
    ...
    set libraries [dict merge $libraries [mem_1::get_design_libraries]]
    set libraries [dict merge $libraries [mem_0::get_design_libraries]]
  ...
  proc get_memory_files {QSYS_SIMDIR} {
    ...
    set memory_files [concat $memory_files [mem_1::get_memory_files "$QSYS_SIMDIR/../../ip/system_design/mem_1/sim/"]]
    set memory_files [concat $memory_files [mem_0::get_memory_files "$QSYS_SIMDIR/../../ip/system_design/mem_0/sim/"]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [mem_1::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/system_design/mem_1/sim/"]]
    set design_files [dict merge $design_files [mem_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/system_design/mem_0/sim/"]]
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [concat $design_files [mem_1::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/system_design/mem_1/sim/"]]
    set design_files [concat $design_files [mem_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/system_design/mem_0/sim/"]]
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/system_design_altera_mm_interconnect_1920_cqreazq.v"]\"  -work altera_mm_interconnect_1920"                             
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_router_1920/sim/system_design_altera_merlin_router_1920_qttnjoi.sv"]\"  -work altera_merlin_router_1920"                              
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_router_1920/sim/system_design_altera_merlin_router_1920_sr4hbxi.sv"]\"  -work altera_merlin_router_1920"                              
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_demultiplexer_1921/sim/system_design_altera_merlin_demultiplexer_1921_ekfzhji.sv"]\"  -work altera_merlin_demultiplexer_1921"         
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_multiplexer_1921/sim/system_design_altera_merlin_multiplexer_1921_cworfkq.sv"]\"  -work altera_merlin_multiplexer_1921"               
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_demultiplexer_1921/sim/system_design_altera_merlin_demultiplexer_1921_xu5xrea.sv"]\"  -work altera_merlin_demultiplexer_1921"         
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_multiplexer_1921/sim/system_design_altera_merlin_multiplexer_1921_bp6ue5y.sv"]\"  -work altera_merlin_multiplexer_1921"               
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_merlin_multiplexer_1921/sim/altera_merlin_arbitrator.sv"]\"  -work altera_merlin_multiplexer_1921"                                           
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../hs_clk_xer_1931/sim/system_design_hs_clk_xer_1931_cgvepdq.v"]\"  -work hs_clk_xer_1931"                                                                 
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_mm_interconnect_1920/sim/system_design_altera_mm_interconnect_1920_n6mddmq.v"]\"  -work altera_mm_interconnect_1920"                             
  ...
  proc get_elab_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append ELAB_OPTIONS [mem_1::get_elab_options $SIMULATOR_TOOL_BITNESS]
    append ELAB_OPTIONS [mem_0::get_elab_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_sim_options {SIMULATOR_TOOL_BITNESS} {
    ...
    append SIM_OPTIONS [mem_1::get_sim_options $SIMULATOR_TOOL_BITNESS]
    append SIM_OPTIONS [mem_0::get_sim_options $SIMULATOR_TOOL_BITNESS]
  ...
  proc get_env_variables {SIMULATOR_TOOL_BITNESS} {
    ...
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mem_1::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
    set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [mem_0::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
