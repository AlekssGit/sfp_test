...
# ----------------------------------------
# If system_design is one of several IP cores in your
...
# ----------------------------------------
<<<<<<< HEAD
# ACDS 21.4 67 win32 2023.05.08.12:08:47
=======
# ACDS 21.3 170 win32 2023.05.07.10:38:18
>>>>>>> 7195fa45c040afc1f0b8147cd5f62971c68e7b2d
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "system_design.system_design"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [system_design::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [system_design::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [system_design::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [system_design::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [system_design::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [system_design::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [system_design::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
