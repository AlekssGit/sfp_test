	component ed_synth_tg is
		port (
			...
			amm_address_0             : out std_logic_vector(29 downto 0);                     -- address
			amm_readdata_0            : in  std_logic_vector(255 downto 0) := (others => 'X'); -- readdata
			amm_writedata_0           : out std_logic_vector(255 downto 0);                    -- writedata
			amm_burstcount_0          : out std_logic_vector(6 downto 0);                      -- burstcount
			amm_byteenable_0          : out std_logic_vector(31 downto 0);                     -- byteenable
			...
			ctrl_ecc_user_interrupt_0 : in  std_logic                      := 'X'              -- ctrl_ecc_user_interrupt
		);
