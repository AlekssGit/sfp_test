...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_corename}"
   } else {
      set fbasename "${::GLOBAL_ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_corename}_${inst_id}"
   }
   ...
   ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_perform_read_capture_analysis $opcname $inst pins var summary

   #######################################
   # Write Analysis

   ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_perform_write_launch_analysis $opcname $inst pins var summary

   #######################################
   # Address/command Analyses

   ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_perform_ac_analysis  $opcname $inst pins var summary

   #######################################
   # DQS Gating Analysis

   ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_perform_dqs_gating_analysis   $opcname $inst pins var summary

   #######################################
   # Write Levelling Analysis

   ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_perform_write_levelling_analysis $opcname $inst pins var summary

   #######################################
   # Analyses related to FPGA core

   ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance

   set summary [lsort -command ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_sort_proc $summary]

   set f -1
   set fname "${fbasename}_summary.csv"

   if { [ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_get_operating_conditions_number] == 0 } {
      set f [open $fname w]

      puts $f "Core: ${::GLOBAL_ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_corename} - Instance: $inst"
   ...
   post_message -type info "Core: ${::GLOBAL_ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ ed_synth_ddr3_altera_emif_arch_nf_191_g66jvjy_round_3dp $hold]
      }
