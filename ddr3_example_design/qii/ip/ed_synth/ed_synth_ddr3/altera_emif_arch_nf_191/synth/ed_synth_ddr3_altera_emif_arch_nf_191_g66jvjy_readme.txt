...
---------------------
 ...
 22. Interface that allows the EMIF calibration processor to talk to its slave components
 23. Instantiating IP in a simulation project
 24. Full-calibration versus skip-calibration simulation
 25. IP Settings
 26. Configuring the Traffic Generator
...
------------------------
   ...
   handbook chapter on Cyclone 10 GX DDR3 External Memory Interface.
...
----------------------
   ...
   The Cyclone 10 GX I/O subsystem is located in the I/O columns. The device has up to
...
--------------------------------------------------------
   ...
   ast_cmd_data_0                 58      input       Command data
...
-----------------------------------------------------------
   ...
   ast_wr_data_0                  360     input       Write data
...
----------------------------------------------------------
   ...
   ast_rd_data_0                  320     output      Read data
...
--------------------
   ...
   SYS_INFO_DEVICE_FAMILY                            : Cyclone 10 GX
   SYS_INFO_DEVICE                                   : 10CX220YF780I5G
   SYS_INFO_DEVICE_SPEEDGRADE                        : 5
   SYS_INFO_DEVICE_TEMPERATURE_GRADE                 : INDUSTRIAL
   SYS_INFO_DEVICE_POWER_MODEL                       : STANDARD
   SYS_INFO_DEVICE_DIE_REVISIONS                     : 
   FAMILY_ENUM                                       : FAMILY_CYCLONE10GX
   ...
   SYS_INFO_UNIQUE_ID                                : ed_synth_ddr3_ddr3
   PREV_PROTOCOL_ENUM                                : PROTOCOL_DDR3
   PHY_FPGA_SPEEDGRADE_GUI                           : I5 (Production) - change device under 'View'->'Device Family'
   PHY_TARGET_SPEEDGRADE                             : I5
   ...
   PHY_MEM_CLK_FREQ_MHZ                              : 932.203
   PHY_REF_CLK_FREQ_MHZ                              : 21.186
   ...
   MEM_DDR3_MR0                                      : 0xe24
   MEM_DDR3_MR1                                      : 0x10006
   MEM_DDR3_MR2                                      : 0x20228
   ...
   MEM_DDR3_RTT_NOM_ENUM                             : DDR3_RTT_NOM_RZQ_4
   ...
   MEM_DDR3_TWTR_CYC                                 : 7
   MEM_DDR3_TFAW_NS                                  : 27.0
   MEM_DDR3_TRRD_CYC                                 : 5
   MEM_DDR3_TRTP_CYC                                 : 7
   MEM_DDR3_TINIT_CK                                 : 466102
   ...
   MEM_DDR3_TRP_CYC                                  : 13
   MEM_DDR3_TRFC_CYC                                 : 243
   MEM_DDR3_TWR_CYC                                  : 14
   MEM_DDR3_TFAW_CYC                                 : 26
   MEM_DDR3_TREFI_CYC                                : 7272
