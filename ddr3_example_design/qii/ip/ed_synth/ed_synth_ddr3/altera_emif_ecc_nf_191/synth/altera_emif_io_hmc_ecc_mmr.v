...
reg  [2                                         : 0] filter_master_rd_data_valid;
...
begin
    ...
    begin
        ...
        filter_master_rd_data_valid <= 3'b000;
    end
    else
    begin
        filter_slave_rd_data_valid  <= slave_ready & slave_read & !master_read;
        filter_master_rd_data_valid <= {filter_master_rd_data_valid[1:0], (master_ready & master_read)};
    end
end
...
assign slave_rd_data_valid  = (int_slave_rd_data_valid == 1'b1) ? (int_slave_rd_data_valid & filter_slave_rd_data_valid) : (master_rd_data_valid & filter_master_rd_data_valid[2]);
