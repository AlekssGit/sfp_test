	ed_synth_ddr3 u0 (
		...
		.amm_readdata_0            (_connected_to_amm_readdata_0_),            //  output,  width = 256,                          .readdata
		.amm_writedata_0           (_connected_to_amm_writedata_0_),           //   input,  width = 256,                          .writedata
		.amm_burstcount_0          (_connected_to_amm_burstcount_0_),          //   input,    width = 7,                          .burstcount
		.amm_byteenable_0          (_connected_to_amm_byteenable_0_),          //   input,   width = 32,                          .byteenable
