	ed_sim_tg u0 (
		...
		.amm_address_0             (_connected_to_amm_address_0_),             //  output,   width = 30,                          .address
		.amm_readdata_0            (_connected_to_amm_readdata_0_),            //   input,  width = 256,                          .readdata
		.amm_writedata_0           (_connected_to_amm_writedata_0_),           //  output,  width = 256,                          .writedata
		.amm_burstcount_0          (_connected_to_amm_burstcount_0_),          //  output,    width = 7,                          .burstcount
		.amm_byteenable_0          (_connected_to_amm_byteenable_0_),          //  output,   width = 32,                          .byteenable
		...
		.ctrl_ecc_user_interrupt_0 (_connected_to_ctrl_ecc_user_interrupt_0_)  //   input,    width = 1, ctrl_ecc_user_interrupt_0.ctrl_ecc_user_interrupt
	);
