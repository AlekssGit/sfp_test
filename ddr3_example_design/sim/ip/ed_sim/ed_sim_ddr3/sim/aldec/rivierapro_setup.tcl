...
# ACDS 21.4 67 win32 2023.04.28.15:40:55
# ----------------------------------------
...
# ----------------------------------------
# If ed_sim_ddr3 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ed_sim_ddr3.ed_sim_ddr3"
}
...
append ELAB_OPTIONS [subst [ed_sim_ddr3::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ed_sim_ddr3::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [ed_sim_ddr3::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [ed_sim_ddr3::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [ed_sim_ddr3::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [ed_sim_ddr3::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
