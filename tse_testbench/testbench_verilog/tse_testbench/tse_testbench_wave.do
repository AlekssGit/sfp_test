...
add wave -noupdate -divider -height 40 {NIGHTFURY PHYIP}

if [regexp {/tb/tx_analogreset} [find signals /tb/tx_analogreset]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/tx_analogreset}
if [regexp {/tb/rx_analogreset} [find signals /tb/rx_analogreset]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/rx_analogreset}

if [regexp {/tb/tx_digitalreset} [find signals /tb/tx_digitalreset]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/tx_digitalreset}
if [regexp {/tb/rx_digitalreset} [find signals /tb/rx_digitalreset]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/rx_digitalreset}

if [regexp {/tb/i_reset_model/tx_digital_reset_count} [find signals /tb/i_reset_model/tx_digital_reset_count]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/i_reset_model/tx_digital_reset_count}
if [regexp {/tb/i_reset_model/rx_digital_reset_count} [find signals /tb/i_reset_model/rx_digital_reset_count]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/i_reset_model/rx_digital_reset_count}

if [regexp {/tb/tx_ready} [find signals /tb/tx_ready]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/tx_ready}
if [regexp {/tb/rx_ready} [find signals /tb/rx_ready]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/rx_ready}
if [regexp {/tb/tx_cal_busy} [find signals /tb/tx_cal_busy]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/tx_cal_busy}
if [regexp {/tb/rx_cal_busy} [find signals /tb/rx_cal_busy]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/rx_cal_busy}

if [regexp {/tb/rx_is_lockedtodata} [find signals /tb/rx_is_lockedtodata]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/rx_is_lockedtodata}
if [regexp {/tb/rx_is_lockedtoref_0} [find signals /tb/rx_is_lockedtoref_0]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/rx_is_lockedtoref_0}

add wave -noupdate -divider -height 40 {Additional clocks}

if [regexp {/tb/tx_serial_clk} [find signals /tb/tx_serial_clk]]                            {add wave -noupdate -format Logic -radix hexadecimal /tb/tx_serial_clk}
