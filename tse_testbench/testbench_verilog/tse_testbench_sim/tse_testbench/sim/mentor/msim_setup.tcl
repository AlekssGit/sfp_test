...
# ----------------------------------------
# If tse_testbench is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.4 67 win32 2022.06.07.00:53:02
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "tse_testbench.tse_testbench"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [tse_testbench::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [tse_testbench::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [tse_testbench::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [tse_testbench::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [tse_testbench::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [tse_testbench::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [tse_testbench::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
